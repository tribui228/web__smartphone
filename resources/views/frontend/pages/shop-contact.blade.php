...
<section class="hero hero-normal">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul >
                            <li ng-repeat="cat in categories" ng-if="cat.parent_id==0">
                                <a href="#">@{{cat.name}}</a>
    ...
    <div class="map">
        <iframe
            src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA66KwUrjxcFG5u0exynlJ45CrbrNe3hEc&q=Trường+Đại+học+Sài+Gòn"
            height="500" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
        <div class="map-inside">
            <i class="icon_pin"></i>
            <div class="inside-widget">
                <h4>Đại học Sài Gòn</h4>
                <ul>
                    <li>Phone: 08.7777.2271</li>
                    <li>273 An D. Vương, Phường 3, Quận 5, TPHCM</li>
                </ul>
            </div>
        </div>
    </div>
